...
from chatbot_search import nlp_model, missing_info, patient_search_wrapper, new_patient_redirect
names_to_functions = {
    "missing_info": missing_info,
    "patient_search_wrapper": patient_search_wrapper,
    "new_patient_redirect": new_patient_redirect
}

tools = [convert_to_openai_tool(missing_info), convert_to_openai_tool(patient_search_wrapper), convert_to_openai_tool(new_patient_redirect)]

tool_choice = "auto"

st.title("Patient Search -- Chatbot")
